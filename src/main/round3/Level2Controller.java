...
public class Level2Controller extends Round3Controller implements Initializable, Runnable {
    @FXML
    ...
    public void init(LinkedList<UserDataLevel2> level2Users, Round3Controller controller) {
    ...
    private void handleMouseClick(MouseEvent e) {
        if (e.getSource() == bt_startTimer) {
            ...
            super.writeToClient(Constants.DIS_R3L2_QST);
    ...
    private void setData() {
        ...
        String time_zh = "限时" + Main.R3L2_DATA.TIME_LIMIT + "分钟";
        String time_en = "Time Limit: " + Main.R3L2_DATA.TIME_LIMIT + ((Main.R3L2_DATA.TIME_LIMIT > 1) ? " minutes" : " minute");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for(int i = 0; i < Main.R3L2_DATA.ROOTS.size(); i++) {
            Label label = new Label();
            roots.add(label);
        }
