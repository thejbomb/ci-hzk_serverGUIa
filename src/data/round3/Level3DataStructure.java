...
public class Level3DataStructure {
    ...
    public Level3DataStructure(String cnInstruction, String enInstruction, int timeLimit, ArrayList<String> examples, ArrayList<String> chars, ArrayList<String> roots, ArrayList<String> answers) {
