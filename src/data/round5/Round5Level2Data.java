...
public class Round5Level2Data {
    ...
    public Round5Level2Data(String cnInstruction, String enInstruction, int timeLimit, ArrayList<String> examples, ArrayList<String> questions) {
